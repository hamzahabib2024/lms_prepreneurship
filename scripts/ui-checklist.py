...
ROLES = {
    ...
    "CourseAdminPage": "Admin, Super Admin",
    "CourseEditPage": "Admin, Super Admin",
    "SubjectEditPage": "Admin, Super Admin",
    "BatchEditPage": "Admin, Super Admin",
...
NOTES = {
    ...
    "CourseAdminPage": "New page. The endpoints to create a programme or a subject had always existed and nothing in the running app could call either. Card grid with the course's own picture, an upload that previews at the size it will appear, and a fee editor with a running total under each block.",
    "CourseEditPage": "The course and its syllabus on one page instead of two panels behind two buttons. Gap banner names what is still missing rather than reporting success on a course nobody can enrol in.",
    "SubjectEditPage": "A page, not a panel. Adds the two columns the schema always had and no form asked for: isActive to retire a subject, and a cover previewed at tile size. Lists the courses that teach it.",
    "BatchEditPage": "Five numbered steps. Fills the worst gap in the system: assigning a teacher, which no screen could do, with each teacher's current load shown beside the name. WhatsApp links settable at last.",
