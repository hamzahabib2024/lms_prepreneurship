 ...
 * straight off the resolved map, and only that shape. A
    ...
    return {
      ...
      copy: {
        ...
        showVerify: bool(resolved["public.showVerify"], true),
        verifyHeading: str(resolved["public.verifyHeading"]),
        verifyBody: str(resolved["public.verifyBody"]),
        verifyCta: str(resolved["public.verifyCta"]),
